...
public class ItemCrystalSeed extends AEBaseItem implements IGrowableCrystal
{
	...
	public ItemCrystalSeed()
	{
		...
		EntityRegistry.registerModEntity( new ResourceLocation( AppEng.MOD_ID, EntityGrowingCrystal.class.getName() ), EntityGrowingCrystal.class, "appliedenergistics2:" + EntityGrowingCrystal.class.getSimpleName(), EntityIds.get( EntityGrowingCrystal.class ), AppEng.instance(), 16, 4, true );
	}
