...
public enum MaterialType
{
	...
	MaterialType( final int metaValue, String modelName, final Set<AEFeature> features, final Class<? extends Entity> c )
	{
		...
		EntityRegistry.registerModEntity( new ResourceLocation( AppEng.MOD_ID, this.droppedEntity.getName() ), this.droppedEntity, "appliedenergistics2:" + this.droppedEntity.getSimpleName(),
